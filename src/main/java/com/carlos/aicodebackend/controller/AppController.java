...
import com.carlos.aicodebackend.annotation.AuthCheck;
import com.carlos.aicodebackend.common.BaseResponse;
import com.carlos.aicodebackend.common.DeleteRequest;
...
import com.carlos.aicodebackend.model.dto.AppAddRequest;
import com.carlos.aicodebackend.model.dto.AppAdminUpdateRequest;
import com.carlos.aicodebackend.model.dto.AppDeployRequest;
import com.carlos.aicodebackend.model.dto.AppQueryRequest;
import com.carlos.aicodebackend.model.dto.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        ...
        // 构造入库对象
        App app = new App();
        cn.hutool.core.bean.BeanUtil.copyProperties(appAddRequest, app);
    ...
    public BaseResponse<Page<AppVO>> listGoodAppVOByPage(@RequestBody AppQueryRequest appQueryRequest) {
        ...
        long pageNum = appQueryRequest.getPageNum();
        // 只查询精选的应用
        appQueryRequest.setPriority(com.carlos.aicodebackend.constant.AppConstant.GOOD_APP_PRIORITY);
        QueryWrapper queryWrapper = appService.getQueryWrapper(appQueryRequest);
        // 分页查询
        Page<App> appPage = appService.page(Page.of(pageNum, pageSize), queryWrapper);
        // 数据封装
